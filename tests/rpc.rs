...
async fn basic_wallet_test() {
    ...
    wallet_test::generate_from_keys(&wallet, generate_wallet_args_1).await;

    let key_pair_2 = common::get_keypair_2();
    let generate_wallet_args_2 = GenerateFromKeysArgs {
        ...
        password: common::PWD_1.to_string(),
        autosave_current: Some(false),
    };
    wallet_test::generate_from_keys(&wallet, generate_wallet_args_2).await;
    let generate_wallet_args_2 = GenerateFromKeysArgs {
        restore_height: Some(0),
        filename: "".to_string(), // empty because will be generated by the below function call
        address: Address::from_keypair(Network::Mainnet, &key_pair_2),
    ...
    wallet_test::generate_from_keys_error_key_already_used(&wallet, generate_wallet_args_2).await;

    let key_pair_3 = common::get_keypair_3();
    ...
    wallet_test::generate_from_keys_error_filename_already_exists(&wallet, generate_wallet_args_3)
        .await;
    let generate_wallet_args_3 = GenerateFromKeysArgs {
    ...
    wallet_test::generate_from_keys_error_invalid_height(&wallet, generate_wallet_args_3).await;
    let generate_wallet_args_3 = GenerateFromKeysArgs {
        restore_height: None,
        filename: "".to_string(), // empty because will be generated by the below function call
