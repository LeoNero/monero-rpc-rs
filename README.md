...
First, for the tests inside `tests/`, you'll need `docker` and `docker-compose` to run the RPC integration tests in case you don't want to run `monerod` and `monero-wallet-rpc` on your own.
